...
const TheadBase = (_a) => {
    ...
    return (React.createElement("thead", Object.assign({ className: react_styles_1.css(className, noWrap && table_1.default.modifiers.nowrap, hasNestedHeader && table_1.default.modifiers.nestedColumnHeader), ref: innerRef }, props), children));
};
