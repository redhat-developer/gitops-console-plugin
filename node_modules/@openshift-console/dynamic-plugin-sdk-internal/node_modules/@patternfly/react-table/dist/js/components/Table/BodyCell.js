...
const BodyCell = (_a) => {
    ...
    if (children) {
        isEmptyStateCell =
            (children.type === react_core_1.Bullseye &&
                children.props.children &&
                children.props.children.type === react_core_1.EmptyState) ||
                children.type === react_core_1.EmptyState;
    }
    const cell = (React.createElement(Td_1.Td, Object.assign({ className: className, component: component, dataLabel: dataLabel && parentId == null && !isEmptyStateCell ? dataLabel : null, onMouseEnter: onMouseEnter, textCenter: textCenter, colSpan: colSpan }, props), children));
