...
import { ExtensionK8sGroupKindModel, K8sModel, PrometheusLabels, PrometheusValue, ResolvedExtension, Selector, PrometheusEndpoint } from '../api/common-types';
...
export declare type ConsoleFetch = (url: string, options?: RequestInit, timeout?: number, cluster?: string) => Promise<Response>;
export declare type ConsoleFetchJSON<T = any> = {
    (url: string, method?: string, options?: RequestInit, timeout?: number, cluster?: string): Promise<T>;
    delete(url: string, json?: any, options?: RequestInit, timeout?: number, cluster?: string): Promise<T>;
    post(url: string, json: any, options?: RequestInit, timeout?: number, cluster?: string): Promise<T>;
    put(url: string, json: any, options?: RequestInit, timeout?: number, cluster?: string): Promise<T>;
    patch(url: string, json: any, options?: RequestInit, timeout?: number, cluster?: string): Promise<T>;
};
