...
import { ClusterOverviewInventoryItem, ClusterOverviewUtilizationItem, ClusterOverviewMultilineUtilizationItem, OverviewDetailItem } from '../extensions/cluster-overview';
...
import { DashboardsTab, DashboardsCard, DashboardsOverviewHealthPrometheusSubsystem, DashboardsOverviewHealthURLSubsystem, DashboardsOverviewHealthResourceSubsystem, DashboardsOverviewHealthOperator, DashboardsInventoryItemGroup, DashboardsOverviewInventoryItem, DashboardsOverviewInventoryItemReplacement, DashboardsProjectOverviewInventoryItem, DashboardsOverviewResourceActivity, DashboardsOverviewPrometheusActivity } from '../extensions/dashboards';
import { FeatureFlag, ModelFeatureFlag, FeatureFlagHookProvider } from '../extensions/feature-flags';
...
import { TopologyComponentFactory, TopologyCreateConnector, TopologyDataModelFactory, TopologyDecoratorProvider, TopologyDisplayFilters, TopologyRelationshipProvider } from '../extensions/topology';
...
export declare type SupportedExtension = FeatureFlag | ModelFeatureFlag | FeatureFlagHookProvider | ReduxReducer | ContextProvider | StandaloneRoutePage | PVCCreateProp | PVCStatus | PVCAlert | PVCDelete | YAMLTemplate | AddAction | AddActionGroup | ImportEnvironment | ClusterGlobalConfig | HrefNavItem | ResourceNSNavItem | ResourceClusterNavItem | Separator | NavSection | FileUpload | ModelMetadata | AlertAction | StorageProvider | TelemetryListener | SupportedCatalogExtensions | SupportedActionExtensions | SupportedTopologyDetailsExtensions | RoutePage | ResourceListPage | ResourceTabPage | ResourceDetailsPage | DashboardsTab | DashboardsCard | DashboardsOverviewHealthPrometheusSubsystem | DashboardsOverviewHealthURLSubsystem | DashboardsOverviewHealthResourceSubsystem | DashboardsOverviewHealthOperator | DashboardsInventoryItemGroup | DashboardsOverviewInventoryItem | DashboardsOverviewInventoryItemReplacement | DashboardsProjectOverviewInventoryItem | DashboardsOverviewResourceActivity | DashboardsOverviewPrometheusActivity | TopologyComponentFactory | TopologyCreateConnector | TopologyDataModelFactory | TopologyDisplayFilters | TopologyDecoratorProvider | TopologyRelationshipProvider | CreateResource | CreateResource | UserPreferenceGroup | UserPreferenceItem | Perspective | HorizontalNavTab | ClusterOverviewInventoryItem | ClusterOverviewUtilizationItem | ClusterOverviewMultilineUtilizationItem | OverviewDetailItem;
/**
 * Schema of Console plugin's `console-extensions.json` file.
 */
export declare type ConsoleExtensionsJSON = (SupportedExtension | CustomExtension)[];
