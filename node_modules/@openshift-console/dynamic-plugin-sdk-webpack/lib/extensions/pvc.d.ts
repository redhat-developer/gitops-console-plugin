...
export declare const isPVCCreateProp: (e: Extension) => e is PVCCreateProp;
export declare const isPVCAlert: (e: Extension) => e is PVCAlert;
export declare const isPVCStatus: (e: Extension) => e is PVCStatus;
export declare const isPVCDelete: (e: Extension) => e is PVCDelete;
