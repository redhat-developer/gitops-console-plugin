...
const consoleFetchCommon = (url, method = 'GET', options = {}, timeout, cluster) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
export const consoleFetchJSON = (url, method = 'GET', options = {}, timeout, cluster) => {
 ...
 */
export const consoleFetchText = (url, options = {}, timeout, cluster) => {
    return consoleFetchCommon(url, 'GET', options, timeout, cluster);
};
const consoleFetchSendJSON = (url, method, json = null, options = {}, timeout, cluster) => {
    const allOptions = {
        headers: {
 ...
 * @param cluster The name of the cluster to make the request to. Defaults to the active cluster the user has selected
 */
consoleFetchJSON.post = (url, json, options = {}, timeout, cluster) => consoleFetchSendJSON(url, 'POST', json, options, timeout, cluster);
/**
 ...
 * @param cluster The name of the cluster to make the request to. Defaults to the active cluster the user has selected
 */
consoleFetchJSON.put = (url, json, options = {}, timeout, cluster) => consoleFetchSendJSON(url, 'PUT', json, options, timeout, cluster);
/**
 ...
 * @param cluster The name of the cluster to make the request to. Defaults to the active cluster the user has selected
 */
consoleFetchJSON.patch = (url, json, options = {}, timeout, cluster) => consoleFetchSendJSON(url, 'PATCH', json, options, timeout, cluster);
