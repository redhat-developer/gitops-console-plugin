    ...
    return (options) => {
        const args = knownArgs.map((arg) => {
            ...
            if (arg === 'opts') {
                ...
                return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (name && { name })), (ns && { ns })), (path && { path })), (queryParams && { queryParams })), (cluster && { cluster }));
            }
            return options[arg];
        });
        return func(...args);
 ...
 */
export const k8sGet = (model, name, ns, opts, requestInit) => coFetchJSON(resourceURL(model, Object.assign({ ns, name }, opts)), 'GET', requestInit, null, opts === null || opts === void 0 ? void 0 : opts.cluster);
/**
...
export const k8sCreate = (model, data, opts = {}) => {
    var _a;
    return coFetchJSON.post(resourceURL(model, Object.assign({ ns: (_a = data === null || data === void 0 ? void 0 : data.metadata) === null || _a === void 0 ? void 0 : _a.namespace }, opts)), data, null, null, opts.cluster);
};
/**
...
export const k8sUpdate = (model, data, ns, name, opts) => {
    var _a, _b;
    return coFetchJSON.put(resourceURL(model, Object.assign({ ns: ns || ((_a = data.metadata) === null || _a === void 0 ? void 0 : _a.namespace), name: name || ((_b = data.metadata) === null || _b === void 0 ? void 0 : _b.name) }, opts)), data, null, null, opts === null || opts === void 0 ? void 0 : opts.cluster);
};
/**
...
export const k8sPatch = (model, resource, data, opts = {}) => {
    ...
    }, opts)), patches, null, null, opts.cluster);
};
/**
...
export const k8sKill = (model, resource, opts = {}, requestInit = {}, json = null) => {
    ...
    return coFetchJSON.delete(resourceURL(model, Object.assign({ ns: resource.metadata.namespace, name: resource.metadata.name }, opts)), jsonData, requestInit, null, opts.cluster);
};
/**
 * It deletes resources from the cluster, based on the provided model, resource.
 * The garbage collection works based on 'Foreground' | 'Background', can be configured with propagationPolicy property in provided model or passed in json.
 ...
 * In case of failure promise gets rejected with HTTP error response.
 * */
export const k8sList = (model, queryParams = {}, raw = false, requestInit = {}, cluster) => {
