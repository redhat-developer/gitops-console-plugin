    ...
    ***************************************************************************** */
    ...
    class Toggle extends React__namespace.Component {
        ...
        render() {
            ...
            /* eslint-enable @typescript-eslint/no-unused-vars */
            id, type } = _a, props = __rest$1(_a, ["className", "children", "isOpen", "isDisabled", "isPlain", "isPrimary", "isSplitButton", "onToggle", 'aria-haspopup', "isActive", "bubbleEvent", "onEnter", "parentRef", "getMenuRef", "id", "type"]);
            return (React__namespace.createElement(DropdownContext.Consumer, null, ({ toggleClass }) => (React__namespace.createElement("button", Object.assign({}, props, { id: id, ref: this.buttonRef, className: css(isSplitButton ? _default$e.dropdownToggleButton : toggleClass || _default$e.dropdownToggle, isActive && _default$e.modifiers.active, isPlain && _default$e.modifiers.plain, isPrimary && _default$e.modifiers.primary, className), type: type || 'button', onClick: event => onToggle(!isOpen, event), "aria-expanded": isOpen, "aria-haspopup": ariaHasPopup, onKeyDown: event => this.onKeyDown(event), disabled: isDisabled }), children))));
        }
    }
    ...
    const PopoverBody = (_a) => {
        var { children, id } = _a, props = __rest$1(_a, ["children", "id"]);
        return (React__namespace.createElement("div", Object.assign({ className: css(_default$6.popoverBody), id: id }, props), children));
    };
    PopoverBody.displayName = 'PopoverBody';

    const PopoverHeader = (_a) => {
        var { children, id } = _a, props = __rest$1(_a, ["children", "id"]);
        return (React__namespace.createElement(PopoverContext.Consumer, null, ({ headerComponent }) => (React__namespace.createElement(Title, Object.assign({ headingLevel: headerComponent, size: TitleSizes.md, id: id }, props), children))));
    };
    ...
    const Popover = (_a) => {
        ...
        const content = (React__namespace.createElement(FocusTrap, Object.assign({ active: focusTrapActive, focusTrapOptions: {
            ...
            }, preventScrollOnDeactivate: true, className: css(_default$6.popover, hasNoPadding && _default$6.modifiers.noPadding, hasAutoWidth && _default$6.modifiers.widthAuto, className), role: "dialog", "aria-modal": "true", "aria-label": headerContent ? undefined : ariaLabel, "aria-labelledby": headerContent ? `popover-${uniqueId}-header` : undefined, "aria-describedby": `popover-${uniqueId}-body`, onMouseDown: onContentMouseDown, style: {
            ...
            React__namespace.createElement(PopoverContent, null,
                ...
                headerContent && (React__namespace.createElement(PopoverHeader, { id: `popover-${uniqueId}-header` }, typeof headerContent === 'function' ? headerContent(hide) : headerContent)),
