...
export const MenuItem = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ role: "none", className: css(styles.menuListItem, isDisabled && styles.modifiers.disabled, _isOnPath && styles.modifiers.currentPath, isLoadButton && styles.modifiers.load, isLoading && styles.modifiers.loading, className), onMouseOver: onMouseOver, tabIndex: -1 }, (flyoutMenu && { onKeyDown: handleFlyout }), { ref: ref }, props),
        React.createElement(Component, Object.assign({ role: "menuitem", tabIndex: -1, onClick: (event) => {
                onItemSelect(event, onSelect);
                _drill && _drill();
            }, className: css(styles.menuItem, getIsSelected() && styles.modifiers.selected, className), "aria-current": getAriaCurrent(), disabled: isDisabled }, additionalProps),
