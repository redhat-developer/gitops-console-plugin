...
class TimePicker extends React.Component {
    constructor(props) {
        ...
        this.isValid = (time) => {
            ...
            const { delimiter, is24Hour } = this.props;
            return TimePickerUtils_1.validateTime(time, this.state.timeRegex, delimiter, !is24Hour);
        };
        ...
        this.onInputChange = (newTime) => {
            if (this.props.onChange) {
                this.props.onChange(newTime, TimePickerUtils_1.getHours(newTime, this.state.timeRegex), TimePickerUtils_1.getMinutes(newTime, this.state.timeRegex), this.isValid(newTime));
            }
        ...
        this.onBlur = (event) => {
            ...
            const { delimiter, is24Hour } = this.props;
            const time = TimePickerUtils_1.parseTime(event.currentTarget.value, timeRegex, delimiter, !is24Hour);
            this.setState({
    ...
    render() {
        ...
        onChange, time, validateTime, inputProps } = _a, props = tslib_1.__rest(_a, ['aria-label', "isDisabled", "className", "placeholder", "id", "menuAppendTo", "is24Hour", "invalidFormatErrorMessage", "direction", "stepMinutes", "width", "delimiter", "onChange", "time", "validateTime", "inputProps"]);
            ...
            React.createElement(InputGroup_1.InputGroup, null,
                React.createElement("div", { className: react_styles_1.css(select_1.default.select, isOpen && select_1.default.modifiers.expanded, direction === Select_1.SelectDirection.up && select_1.default.modifiers.top, className), id: randomId, ref: this.parentRef },
                    React.createElement("div", { ref: this.toggleRef, className: react_styles_1.css(select_1.default.selectToggle, isDisabled && select_1.default.modifiers.disabled, select_1.default.modifiers.typeahead), style: { paddingLeft: '0' } },
                        React.createElement(TextInput_1.TextInput, Object.assign({ className: react_styles_1.css(form_control_1.default.formControl, select_1.default.selectToggleTypeahead), id: `${randomId}-input`, "aria-label": ariaLabel, validated: isInvalid ? 'error' : 'default', placeholder: placeholder, value: timeState || '', type: "text", iconVariant: "clock", onClick: this.onInputFocus, onFocus: this.onInputFocus, onChange: this.onInputChange, onBlur: this.onBlur, autoComplete: "off", isDisabled: isDisabled, ref: this.inputRef }, inputProps))),
        ...
        const popperContainer = (React.createElement("div", { className: react_styles_1.css(select_1.default.select, isOpen && select_1.default.modifiers.expanded, direction === Select_1.SelectDirection.up && select_1.default.modifiers.top, className) }, isOpen && menuContainer));
