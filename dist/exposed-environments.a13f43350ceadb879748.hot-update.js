...
const fetchAppGroups = (baseURL, manifestURL) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        data = yield (0,_openshift_console_dynamic_plugin_sdk__WEBPACK_IMPORTED_MODULE_0__.consoleFetchJSON)(`${newListApi}?url=${manifestURL}`);
    }
    catch (err) {
...
//# sourceMappingURL=exposed-environments.a13f43350ceadb879748.hot-update.js.map