...
const GitOpsList = ({ appGroups, emptyStateMsg }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "gop-gitops-list" }, !emptyStateMsg && appGroups ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "co-m-pane__filter-row" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(TextFilter, { value: textFilter, label: t('gitops-plugin~by name'), label: t('gitops-plugin~by name'), onChange: (val) => setTextFilter(val) })),
...
//# sourceMappingURL=exposed-environments.d9e72442e4771b649ab7.hot-update.js.map