...
// From Console for now and may be needed later
import { K8sModel, K8sVerb, MatchLabels, Selector } from '@openshift-console/dynamic-plugin-sdk';
import {
  K8sResourceCommon,
...
export * from '@openshift-console/dynamic-plugin-sdk';
